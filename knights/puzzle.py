...
# B says nothing.
knowledge1 = And(Implication(AKnight, Not(AKnave)),
                 Implication(AKnave, Not(AKnight)),    
...
knowledge2 = And(
    ...
    Implication(Or(And(BKnave, AKnight), And(BKnight, AKnave)), BKnight),
    Implication(Not(Or(And(BKnave, AKnight), And(BKnight, AKnave))), BKnave)
